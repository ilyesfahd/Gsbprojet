...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 16 déc. 2025 à 11:50
...
('b59', 'Cottin', 'Vincenne', '36 sq Capucins', '05000', 'GAP', '1995-10-21 00:00:00', 1, NULL, 'RA'),
('c14', 'Daburon', 'François', '13 r Champs Elysées', '06000', 'NICE', '1989-02-01 00:00:00', 1, NULL, 'PA'),
...
('e49', 'Duncombe', 'Claude', '19 av Alsace Lorraine', '09000', 'FOIX', '1996-02-19 00:00:00', 1, NULL, 'OC'),
...
('n59', 'Maffezzoli', 'Thibaud', '5 r Chateaubriand', '02000', 'LAON', '1994-12-19 00:00:00', 2, NULL, 'HF'),
...
CREATE TABLE IF NOT EXISTS `departement` (
  `NoDEPT` varchar(2) COLLATE utf8_bin NOT NULL,
  `Departement` varchar(30) COLLATE utf8_bin NOT NULL,
...
('02', 'Aisne', 'HF'),
('03', 'Allier', 'RA'),
('04', 'Alpes-de-Haute-Provence', 'PA'),
('05', 'Hautes-Alpes', 'PA'),
('06', 'Alpes-Maritimes', 'PA'),
('07', 'Ardeche', 'RA'),
('08', 'Ardennes', 'GE'),
('09', 'Ariege', 'OC'),
('10', 'Aube', 'GE'),
