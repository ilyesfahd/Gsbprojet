        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <a href="index.php?uc=rapports&action=detailPraticien&pra=<?= $rapport['PRA_NUM'] ?>&retour_url=<?= urlencode($_SERVER['REQUEST_URI']) ?>" class="text-decoration-none">
                ...
                <div class="col-md-6">
                    ...
                    <?php if (!empty($rapport['PRA_NUM_REMPLACANT']) && !empty($rapport['PRA_REMP_NOM'])) : ?>
                        <a href="index.php?uc=rapports&action=detailPraticien&pra=<?= $rapport['PRA_NUM_REMPLACANT'] ?>&retour_url=<?= urlencode($_SERVER['REQUEST_URI']) ?>" class="text-decoration-none">
