<section class="container mt-4 mb-5">
    ...
    <div class="mt-4">
        <?php
        if (isset($_GET['retour_url']) && !empty($_GET['retour_url'])) {
            $retourUrl = filter_input(INPUT_GET, 'retour_url', FILTER_SANITIZE_URL);
            echo '<a href="' . htmlspecialchars($retourUrl) . '" class="btn btn-outline-secondary">Retour au rapport</a>';
        } elseif (isset($_SESSION['criteres_recherche']) && !isset($retour)) {
        ...
        } elseif (isset($retour) && ($retour == 'nouveaux' || $retour == 'rapport')) {
