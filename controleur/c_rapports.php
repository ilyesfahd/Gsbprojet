...
switch ($action) {
    ...
    case 'enregistrer':
        ...
        if ($praticienNum > 0 && $praticienRemplacant > 0 && $praticienNum === $praticienRemplacant) {
            $erreurs[] = "Le praticien remplaçant ne peut pas être le même que le praticien visité.";
        }
        ...
        if ($success) {
            ...
            // Rediriger vers la liste appropriée avec le message
