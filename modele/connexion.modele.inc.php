...
function checkConnexion($username, $mdp)
{
    ...
    try {
        ...
        $req = $getInfo->prepare('SELECT l.LOG_ID as \'id_log\', l.COL_MATRICULE as \'matricule\', c.HAB_ID as \'habilitation\', c.REG_CODE as \'region\', c.SEC_CODE as \'secteur\' FROM login l INNER JOIN collaborateur c ON l.COL_MATRICULE = c.COL_MATRICULE WHERE l.LOG_LOGIN = :identifiant AND l.LOG_MOTDEPASSE = "' . hash('sha512', $mdp) . '"');
